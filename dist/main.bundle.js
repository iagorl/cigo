...
var CigoPageComponent = (function () {
    function CigoPageComponent(dataService) {
        ...
        this.timer = __WEBPACK_IMPORTED_MODULE_2_rxjs_observable_TimerObservable__["a" /* TimerObservable */].create(0, 100);
    ...
    CigoPageComponent.prototype.ngOnInit = function () {
        ...
        this.timer.subscribe(function (t) {
            if (t % _this.viewTimer === 0 || _this.resetViews) {
                if (t % 600 === 0) {
    ...
    CigoPageComponent.prototype.changeData = function (chart) {
        ...
        this.dataService.dataCigo$.subscribe(function (data) {
            ...
            if (chart in data) {
                ...
                _this.view[1] = 100 * _this.firstData.length / (_this.rowNumber + 1);
    ...
    CigoPageComponent.prototype.setViews = function () {
    ...
    CigoPageComponent.prototype.validate = function () {
        this.form.invalidRowNumber = this.form.rowNumber <= 0 || this.form.rowNumber > 24;
    };
    CigoPageComponent.prototype.validateFilterSelection = function () {
        var selection = this.form.views.filter(function (view) { return view.active === true; });
        this.validSelection = selection.length > 0 ? true : false;
    };
    CigoPageComponent.prototype.activateViews = function () {
        this.filters = this.form.views.filter(function (view) { return view.active === true; });
...
var CigoDataService = (function () {
    ...
    CigoDataService.prototype.parsePropertyValue = function (value) {
